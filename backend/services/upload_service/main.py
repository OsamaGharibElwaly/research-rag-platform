"""Upload service main application."""
...
app = FastAPI(
    ...
    description="PDF upload microservice for AI Research Paper Assistant",
    version="1.0.0",
    lifespan=lifespan,
)
...
if __name__ == "__main__":
    ...
    from backend.services.upload_service.config import SERVICE_PORT

    uvicorn.run(
        "backend.services.upload_service.main:app",
        host="0.0.0.0",
        port=SERVICE_PORT,
        reload=True,
    )
